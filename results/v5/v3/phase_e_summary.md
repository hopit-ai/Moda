...
_Generated: 2026-05-17 15:04:03_

## Per-benchmark MRR (1K-subsample protocol)

| Benchmark | SL2 base | v5 trained | Δ vs SL2 | FSL (target) | Δ vs FSL |
|---|---:|---:|---:|---:|---:|
| fashion200k | 0.4145 | **0.4157** | +0.3% | 0.4551 | -8.6% |
| atlas | 0.4910 | **0.4897** | -0.3% | 0.4226 | +15.9% |
| polyvore | 0.7745 | **0.7779** | +0.4% | 0.7402 | +5.1% |
| KAGL | 0.5570 | **0.5620** | +0.9% | 0.5805 | -3.2% |
